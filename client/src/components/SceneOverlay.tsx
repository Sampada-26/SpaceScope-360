      ...
      >
        <div className="max-w-3xl text-center">
          <div className="text-xs tracking-[0.35em] text-white/60 uppercase">
            Space Events • Missions • Cosmic Weather • Earth Impact
          </div>
          ...
          <p className="mt-5 text-white/70 text-base md:text-lg leading-relaxed">
            A centralized platform to explore upcoming sky events, monitor real-time space weather,
            follow global mission timelines, and learn how satellite data supports life on Earth.
          </p>

          <div className="mt-7 flex items-center justify-center gap-3 pointer-events-auto">
            <GlassButton variant="glow">Launch Dashboard</GlassButton>
            <GlassButton variant="outline">Explore Learning</GlassButton>
          </div>
