        ...
        <div className="mt-10 grid gap-8 lg:grid-cols-[1fr_1.3fr_1fr] items-start">
          <div className="glass rounded-3xl p-6 border border-white/10 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="text-xs uppercase tracking-[0.2em] text-emerald-200/70">{t("Why Protect Earth?")}</div>
          ...
          <div className="glass rounded-3xl p-6 border border-white/10 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="text-xs uppercase tracking-[0.2em] text-cyan-200/70">{t("Planet Health Monitor")}</div>
