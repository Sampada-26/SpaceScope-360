...
function BusinessModelDiagram() {
  return (
    <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-black/30 p-5 md:p-7">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(34,211,238,0.16),transparent_55%)]" />
      <div className="absolute inset-0 opacity-25 bg-[radial-gradient(circle,rgba(255,255,255,0.10)_1px,transparent_1px)] [background-size:18px_18px]" />
      <div className="relative">
        <div className="flex items-center justify-between gap-3">
          <div>
            ...
            <p className="mt-2 text-sm text-white/75">
              Cross-subsidized flywheel: free local engagement drives scale, scale unlocks
              premium + contracts, Proof of Impact makes ROI verifiable.
            </p>
          </div>
          <div className="hidden md:block rounded-xl border border-white/10 bg-white/5 px-3 py-2 text-xs text-white/70">
        ...
        <svg
          ...
          role="img"
          aria-label="SpaceScope 360 business model diagram"
        >
          <defs>
          ...
          <rect x="0" y="0" width="1200" height="520" rx="22" fill="rgba(255,255,255,0.03)" stroke="rgba(255,255,255,0.12)" />

          {/* Left: Free engagement */}
          <rect x="60" y="120" width="330" height="170" rx="18" fill="rgba(34,211,238,0.10)" stroke="rgba(34,211,238,0.30)" />
          <text x="90" y="160" fill="rgba(255,255,255,0.92)" fontSize="20" fontWeight="700">
            Free, Localized Public Value
          </text>
          <text x="90" y="190" fill="rgba(255,255,255,0.70)" fontSize="15">
            Bhasha Mode (Hindi/Marathi)
          </text>
          <text x="90" y="214" fill="rgba(255,255,255,0.70)" fontSize="15">
            Smart visibility notifications
          </text>
          <text x="90" y="238" fill="rgba(255,255,255,0.70)" fontSize="15">
            Disaster + agriculture insights
          </text>
          <text x="90" y="262" fill="rgba(255,255,255,0.70)" fontSize="15">
            Gamified learning access
          </text>

          {/* Center: Scale + Proof */}
          <rect x="435" y="70" width="330" height="260" rx="18" fill="url(#g)" stroke="rgba(255,255,255,0.16)" />
          <text x="465" y="112" fill="rgba(255,255,255,0.95)" fontSize="20" fontWeight="800">
            Proof of Impact Ledger
          </text>
          <text x="465" y="142" fill="rgba(255,255,255,0.78)" fontSize="15">
            Logs verifiable user actions from space data
          </text>
          <text x="465" y="166" fill="rgba(255,255,255,0.78)" fontSize="15">
            Converts insights into measurable Social ROI
          </text>
          <text x="465" y="190" fill="rgba(255,255,255,0.78)" fontSize="15">
            Builds trust for schools, investors, governments
          </text>
          <text x="465" y="230" fill="rgba(255,255,255,0.85)" fontSize="16" fontWeight="700">
            Scale Engine
          </text>
          <text x="465" y="254" fill="rgba(255,255,255,0.74)" fontSize="15">
            Massive user base via free engagement
          </text>
          <text x="465" y="278" fill="rgba(255,255,255,0.74)" fontSize="15">
            Strong partnerships (schools + NGOs)
          </text>

          {/* Right: Monetization */}
          <rect x="810" y="120" width="330" height="170" rx="18" fill="rgba(99,102,241,0.10)" stroke="rgba(99,102,241,0.30)" />
          <text x="840" y="160" fill="rgba(255,255,255,0.92)" fontSize="20" fontWeight="700">
            Revenue Streams
          </text>
          <text x="840" y="190" fill="rgba(255,255,255,0.70)" fontSize="15">
            Premium education certifications
          </text>
          <text x="840" y="214" fill="rgba(255,255,255,0.70)" fontSize="15">
            GovTech subscriptions / contracts
          </text>
          <text x="840" y="238" fill="rgba(255,255,255,0.70)" fontSize="15">
            SaaS/API licensing (B2B)
          </text>
          <text x="840" y="262" fill="rgba(255,255,255,0.70)" fontSize="15">
            Commissions: STEM kits, telescopes
          </text>

          {/* Bottom: Cost structure */}
          <rect x="260" y="360" width="680" height="120" rx="18" fill="rgba(255,255,255,0.05)" stroke="rgba(255,255,255,0.14)" />
          <text x="290" y="398" fill="rgba(255,255,255,0.92)" fontSize="18" fontWeight="800">
            Cost Structure
          </text>
          <text x="290" y="426" fill="rgba(255,255,255,0.70)" fontSize="15">
            Cloud & API Infrastructure • Localization & Bhasha Engine • Content Development • Partnership Marketing
          </text>

          {/* Arrows */}
          <path
            d="M390 205 C420 205, 420 205, 435 205"
            fill="none"
          ...
          />
          <path
            d="M765 205 C795 205, 795 205, 810 205"
            fill="none"
            stroke="rgba(255,255,255,0.55)"
            strokeWidth="2"
            markerEnd="url(#arrow)"
          />
          <path
            d="M600 330 C600 350, 600 350, 600 360"
            fill="none"
            stroke="rgba(255,255,255,0.55)"
            strokeWidth="2"
            markerEnd="url(#arrow)"
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            {
              t: "What we unify",
              d: "Space events, missions, and real-time cosmic conditions into one ecosystem.",
            },
            {
              t: "Why it works",
              d: "Green/Red alerts + visibility rules make complexity usable for the public.",
            },
            {
              t: "What makes it unique",
              d: "Proof of Impact Ledger turns usage into verifiable, fundable outcomes.",
            },
          ].map((b) => (
            <div key={b.t} className="rounded-2xl border border-white/10 bg-black/25 p-5">
