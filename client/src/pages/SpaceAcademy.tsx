...
import { Rocket, Trophy, Star, Zap, CheckCircle2, XCircle, AlertCircle, ChevronRight, GraduationCap, Map as MapIcon, RotateCcw, Lock } from 'lucide-react';
...
const SpaceAcademy: React.FC<Props> = ({ visible }) => {
  ...
  // If you want to see the UI while coding, you can comment out the return null
  // But for the final hackathon, this respects the App.tsx scroll logic
  ...
  return (
    <div className="fixed inset-0 z-[100] overflow-y-auto pointer-events-auto bg-[#020617]/80 backdrop-blur-2xl pt-24 pb-20 px-4 animate-in fade-in duration-700">
